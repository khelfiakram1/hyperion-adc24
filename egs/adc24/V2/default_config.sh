...
# bpe_model=data/qasr/ara_lang_bpe_1000/bpe.model
# # x-vector cfg
...
# nnet_name=${hf_model_name}_qasr_transducer_1000_2GPU_v1.0
...
# # bpe_model=data/mgb3_hf/egy_lang_bpe_7000/bpe.model
# # # x-vector cfg
...
# # nnet_name=${hf_model_name}_egy_transducer_v1.0
# # nnet_s1_name=$nnet_name.s1
