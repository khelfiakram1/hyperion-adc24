...
def remove_outlayers(x, class_id):
    bound = 100
...
def train_be(
    ...
    **kwargs
    ...
    plda = F.create(plda_type, y_dim=y_dim, z_dim=z_dim, name="plda")
    elbo = plda.fit(x_ln, class_id, epochs=epochs, ml_md=ml_md, md_epochs=md_epochs)
